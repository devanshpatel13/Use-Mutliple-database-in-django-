...
register the viewset with a routers and let the URL conf be determined
automatically.

    routers = DefaultRouter()
    routers.register(r'users', UserViewSet, 'user')
...
class ViewSetMixin:
    ...
    def as_view(cls, actions=None, **initkwargs):
        ...
        # value is provided by the routers through the initkwargs.
        cls.basename = None
