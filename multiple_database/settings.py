...
SECRET_KEY = 'django-insecure-t%&fvg#t4ig3+=jlh_@@6qx733p**_oy2+e%dl145gt82r(=@&'
...
DATABASE_ROUTERS = ['routers.db_routers.AuthRouters', 'routers.db_routers.Mongo','routers.db_routers.Postgres' ]